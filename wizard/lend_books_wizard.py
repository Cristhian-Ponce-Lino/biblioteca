...
class ReportWizard(models.Model):
    ...
    lend_book_ids = fields.One2many('biblioteca.lend.books', 'lend_book_wizard_id', string='Nombre de libro')
    ...
    def search_action_filter(self):
        ...
        if filter:
            self.lend_book_ids = [(6, 0, filter.ids)]   #  crea las linea
           # self.lend_book_ids = [(5, 0, 0)]   # limpia las lineas
